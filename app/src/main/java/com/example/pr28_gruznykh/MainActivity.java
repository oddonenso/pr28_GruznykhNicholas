package com.example.pr28_gruznykh;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) ImageView clockImageView = findViewById(R.id.clock);
// анимация для вращения часов
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) ImageView hourImageView = findViewById(R.id.hour_hand);
